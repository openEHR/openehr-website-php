<span style="line-height:150%;"><a href="/programs/specification" <?php if($PageName == 'Specification Program'){?> class="active"<?php }?> style="font-weight:900;">Specification<br/>Program</a></span>
			<ul>
				<li><a href="/programs/specification/listofspecifications" <?php if($PageName == 'List of Specifications'){?> class="active"<?php }?>>&nbsp; List of Specifications</a></li>
				<li><a href="/programs/specification/releases" <?php if($PageName == 'Releases'){?> class="active"<?php }?>>&nbsp; Releases</a></li>
				<li><a href="/programs/specification/roadmap" <?php if($PageName == 'Roadmap'){?> class="active"<?php }?>>&nbsp; Roadmap</a></li>
				...
				<li><a href="/issues/browse/SPEC" target="_blank">&nbsp; Change Tracker</a></li>
