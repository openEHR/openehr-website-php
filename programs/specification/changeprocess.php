...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<ul>
				<li><b>Koray Atalag</b>, university of Auckland, New Zealand</li>
			</ul>


			<h2><a name="lifecycle"></a>Specification Lifecycle</h2>
			<p class="par">All specification artefacts, both documentary and computable follow a lifecycle, from inception (or accession, in the case of donated works) to stability to obsolescence. The following formal lifecycle states are recognised: Development, Trial, Stable, Obsolete and Superseded. For specifications developed from scratch within openEHR (i.e. not donated), the management is as follows:</p>
			<ul>
			...
			<br/>
			<p class="par"><font color="#ff0000">TBD: Possible variants:</font></p>
			<ul>
			...
			<p class="par">For reference, other lifecycle management specifications:</p>
			<ul>
			...
			<h4>Creation</h4>
			<p class="par">New CRs are created by the EC on the <a href="http://www.openehr.org/issues/browse/SPEC">SPEC CR tracker</a> . The following information is initially required:</p>
			<ul>
			...
			<h4>Acceptance</h4>
			<p class="par">Every CR has to initially be accepted or rejected by the EC. This primarily means determining if:</p>
			<ul>
				<li>the CR responds to a real need</li>
				<li>if the CR is compatible with the current specification library.</li>
			</ul><br/>
			<p class="par">For every CR accepted, the following information is added:</p>
			<ul>
			...
			<p class="par">The Change Owner is now responsible for obtaining the following information from the CMG:</p>
			<ul>
				<li>impact assessment;</li>
				<li>detailed description of proposed changes;</li>
				<li>revised classification if necessary.</li>
			</ul><br/>
			<p class="par">The EC reviews the CR again. If the impact is deemed acceptable, the CR is allocated to a release.</p>
			<ul>
			...
			<h4>Approval</h4>
			<p class="par">The initially completed work of a CR is approved as follows:</p>
			<ul>
			...
			<p>New specifications can be proposed by any member of the openEHR community. Formally this is done via either a PR on the SPEC PR tracker, or if the proposer is a Program member, a CR on the <a href="http://www.openehr.org/issues/browse/SPEC" class="external-link" rel="nofollow">SPEC project tracker</a> . If the initial need is described in a PR, it will be reviewed by the EC which may decide to create a CR for it. If this happens, the CR will cover the initial period of establishment of the specification, including its identification and setting of scope.</p>
			...
			<p class="par">A successful application to add a new specification results in the following being decided by the Editorial Committee:</p>
			<ul>
				<li>an identifier</li>
				<li>a title</li>
			...
			<p class="par">New specifications can be created in two ways.</p>
			<ul>
			...
			<p class="par">All openEHR specifications should include the following standard sections:</p>
			<ul>
			...
			<p class="par">In addition, the following sections or information should be included where appropriate:</p>
			<ul>
