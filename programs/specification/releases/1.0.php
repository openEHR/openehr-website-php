...
<head>
	...
	<link rel="bookmark" href="http://www.openehr.org/programs/specification/releases/1.0" title="openEHR - Specification Program">
...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<p><a href="http://www.openehr.org/issues/browse/SPEC/fixforversion/10018">Release notes</a> for this release. The rules for change management between releases are given in the <a href="../releasestrategy">Release Strategy</a>.</p>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/requirements/iso18308_conformance.pdf" target="_blank">ISO 18308 Conformance Statement</a></td>
			...
			<tr>
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/overview.pdf" target="_blank">Architecture Overview</a></td>
				<td class="TableMainC"> &nbsp;</td>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/ehr_im.pdf" target="_blank">EHR IM</a> </td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
				<td class="TableMainC"> The information model of the openEHR EHR. </td>
				<td class="TableMainC"> stable</td>
			</tr>
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/demographic_im.pdf" target="_blank">Demographic IM</a> </td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#FFFFDD;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/ehr_extract_im.pdf" target="_blank">EHR Extract IM</a> </td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/common_im.pdf" target="_blank">Common IM</a> </td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/data_structures_im.pdf" target="_blank">Data Structures IM</a> </td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/data_types_im.pdf" target="_blank">Data Types IM</a></td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/support_im.pdf" target="_blank">Support IM</a> </td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#FFEECC;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/rm/integration_im.pdf" target="_blank">Integration IM</a></td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#FFFFDD;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/am/archetype_system.pdf" target="_blank">Archetype System</a></td>
				<td class="TableMainC"> &nbsp;</td>
			...
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/am/adl.pdf" target="_blank">Archetype Definition Language 1.3 (ADL)</a></td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
				<td class="TableMainC"> Abstract syntax specification for archetypes 1.3 edition of language (used in ISO 13606-2). </td>
				<td class="TableMainC"> stable</td>
			</tr>
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/am/aom.pdf" target="_blank">Archetype Object Model (AOM)</a></td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
				<td class="TableMainC"> Object model of archetypes corresponding to ADL 1.3. </td>
				<td class="TableMainC"> stable</td>
			</tr>
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/am/openehr_archetype_profile.pdf" target="_blank">openEHR Archetype Profile (OAP)</a></td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				<td class="TableMainC" style="background-color:#FFFFFF;"> &nbsp;</td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/am/archetype_principles.pdf" target="_blank">Archetypes Principles</a></td>
				<td class="TableMainC"> UML: <a href="http://www.openehr.org/releases/1.0/architecture/computable/UML/uml.html">source files</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/terminology.pdf" target="_blank">openEHR Vocabulary</a> </td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/computable/terminology/terminology.html">XML source file</a> </td>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/CM/CM_plan.pdf">CM Plan</a> </td>
				<td class="TableMainC"> &nbsp;</td>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/architecture/modelling_guide.pdf">Modelling Guide</a> </td>
				<td class="TableMainC"> &nbsp;</td>
				<td class="TableMainC"> Technical document describing how versioning, changes, and releases are made. Describes the workflow of the Architectural Review Board (ARB).</td>
				<td class="TableMainC"> stable</td>
			</tr>
			<tr>
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/its/XML-schema/index.html">XML Schema Homepage</a> </td>
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/its/XML-schema/index.html">XSDs</a> </td>
			...
			<tr style="background-color:#FFEECC;">
				...
				<td class="TableMainC"> <a href="http://www.openehr.org/releases/1.0/its/Java/openEHR-JavaITS.pdf">Java Development Guide</a> </td>
				<td class="TableMainC"> &nbsp; </td>
