...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<p class="par">The responsibilities of the Editorial Committee are:</p>
		<ul>
		...
		<p class="par">The responsibilities of the co-chairs are as follows:</p>
		<ul>
		...
		<p class="par">The responsibilities of a CMG are:</p>
		<ul>
		...
		<p>The membership of each CMG is recorded online at the <a href="http://www.openehr.org/issues/browse/SPEC" class="external-link" rel="nofollow">SPEC tracker location</a> .</p>
		...
		<p class="par">A new non-core CMG is created based on a successful proposal by any Program member to the EC, which details:</p>
		<ul>
		...
		<ul>
			...
			<li>To act as the <b>openEHR official liaison</b> to the relevant SDO of subgroup thereof.</li>
		</ul>
		...
		<p>The membership of each SAG is recorded online at the <a href="http://www.openehr.org/issues/browse/SPEC" class="external-link" rel="nofollow">SPEC tracker location</a>.</p>

		<h4><a name="sagcreation"></a>Creation</h4>
		<p class="par">A new SAG is created based on a successful proposal by any Program member to the EC, which details:</p>
		<ul>
		...
		<p class="par">To ensure fairness and representativeness of the Program, the following rules are provided.</p>
		<ul>
		...
		<p class="par">New members of the Specifications Program join as a member of one or more CMGs and/or SAGs. New nominations may be made in the following situations:</p>
		<ul>
