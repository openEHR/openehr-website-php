...
<div id="MainFrame">
	...
	<div id="MainArea" style="height:450px;">
		...
		<div id="TextArea">
			...
			<p>The openEHR software program aims to support software development based on,
			or related to, the openEHR specifications.</p>

			<h2>Current Activities</h2>
			<p>Most current openEHR related software projects are self-governed and self-funded by various
			...
			software focused mailing lists</a> and partly also the <a href="../specification/mailinglists">specification focused mailing lists</a>.</p>
			<p>The program also coordinates hosting of some software projects that have
			...
			including some incubation process</a> etc. (See also: <a href="iplicense">license preferences</a>.)</p>
			<p>The program strives to increase awareness of available openEHR implementations.
			A wiki page lists <a href="http://www.openehr.org/wiki/display/projects/">known openEHR-related software projects</a>.
			Other implementation related information can be found at the <a href="http://www.openehr.org/wiki/display/dev/">developer related wiki-pages</a></p>

			<h2>Potential future activities</h2>
			<p>The future direction of the software programme is always open for community discussion
			(primarily using the <a href="mailinglists">openehr-implementers mail list</a>). Some initial suggestions are:</p> 
			<ul>
