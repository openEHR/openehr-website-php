...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<p>The openEHR community is now formally reviewing a set of archetypes for clinical use in an international setting. This is available via a web-based controlled <a href="http://www.openehr.org/wiki/display/healthmod/Clinical+Knowledge+Manager">authoring environment</a>. The evaluation is proceeding under the guidance of Dr Heather Leslie and the Archetype Editorial Group.
			
			<h3>Background</h3>
			<p>Models of clinical information exist in every computer system that is used in health care. While doctors, nurses and other health professionals share many clinical concepts and can
			communicate very effectively about these concepts, computers have not had a standard means of representing clinical information. openEHR offers this capability and in doing so provides a platform for health care computing. If we do not have such a platform then the benefits of computing in health care will be very slow coming and require absolutely massive investment.</p>
			...
			<p>Terminologies used in Healthcare include <a href="http://www.who.int/classifications/icd/en/">ICD-10</a> (and its predecessor ICD-9), <a href="http://www.ihtsdo.org/snomed-ct/">SNOMED-CT</a>, <a href="http://loinc.org/">LOINC</a> and many others.</p>
			...
			<p>One often hears that coded data are essential for semantic interoperability and decision support. Coding is the use of symbolic,  or alphanumeric identifiers to tag data items as referring to concepts
			or terms from an agreed vocabulary or ontology. Coding, may, in many circumstances have some value. But it also comes at a price. This <a href="http://www.openehr.org/wiki/display/healthmod/Codes%2C+EHRs+and+Semantic+Interoperability">article</a> looks at the balance sheet to tease out the issues facing those making recommendations for electronic health records and semantic interoperability.</p>
			
			
			<h2>Clinical Knowledge Governance</h2>
			<p>The openEHR <a href="ckmdocumentation">Clinical Knowledge Manager (CKM) (available <a href="www.openehr.org/knowledge">here</a>) is an online application that supports knowledge governance within and across the health enterprise.  In practice, it is a system for collaborative development, management and publishing of a wide range of clinical knowledge resources including archetypes, templates and terminology subsets.</p>
