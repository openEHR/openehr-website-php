...
<div id="MainFrame">
	...
	<div id="MainArea" style="height:450px;">
		...
		<div id="TextArea">
			...
			<p>The latest beta of the ADL 1.5 Workbench for Windows, Mac and Linux can now be downloaded from the <a href="http://www.openehr.org/new-ws/site/downloads/ADLworkbench/home">help page</a>.</p>
			<p>It includes significant UI improvements, and an implementation of annotations as recently discussed on the lists. Release notes <a href="http://www.openehr.org/new-ws/site/downloads/ADLworkbench/releasenotes">here</a>. As indicated in the online documentation, please report all problems on the <a href="http://www.openehr.org/issues/browse/AWBPR">dedicated Jira issue tracker</a>.As this is a beta, the more people who download and test the tool on all platforms, the faster the quality improves.</p>
