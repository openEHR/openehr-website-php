...
<div id="MainFrame">
	...
	<div id="MainArea" style="height:500px;">
		...
		<div id="TextArea">
			...
			<br/>
			<p>ADL syntax highlight for Notepad++ was developed by Armando Prieto from Venezuela. Find more information about ADL Text Editors on <a href="http://www.openehr.org/wiki/display/dev/ADL+Text+Editors">Wiki</a>.</p>
			<br/>
