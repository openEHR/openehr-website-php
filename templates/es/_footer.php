			...
			<div class="BottomMenuPart floatLeft">
				<div class="BottomMenuSection floatLeft">
					...
					<ul>
						...
						<li><a href="/es/resources/white_papers">Libros Blancos</a></li>
						<li><a href="/es/resources/related_projects">Proyectos Relacionados</a></li>
					</ul>
				</div>
				...
				<div class="BottomMenuSection floatRight">
					...
					<ul>
						...
						<li><a href="/es/community/mailinglists">Listas de Correo</a></li>
