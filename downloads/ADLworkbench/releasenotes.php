...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<ul>
				...
				<ul><li>JSON is now supported as an output format for differential and flat archetypes. Note that occurrences, cardinality and existence are serialised with single Strings, e.g. "0..1", "1..*" etc.</li></ul>
				</li>
			</ul>
			...
			<ul>
				<li value="0">Added regression testing facility so that any archetype can now include in its description section an expected compilation result,
				...
				<li value="0">improve validation of languages, now minimally enforce IETF language-tag format (<a href="http://tools.ietf.org/html/rfc5646">RFC 5646</a> - this
				...
				<li value="0">fixed a bug in the 2nd pass validator that was sometimes preventing subtrees in specialised archetypes from being correctly validated against
				their correspondents in parent archetypes</li>
				<li value="0">Fix various launch / shut-down / minimise annoyances, especially on multiple screen systems;</li>
				<li value="0">Fix node map rendering problem where multiple value attributes with existence = 1 not showing up in red but pink.
				Existence is now taken into account for this rendering.</li>
				<li value="0">Added profile chooser combo box to archetype explorer on main page;</li>
				<li value="0">Archetype id search facility added to id control on main page. This allows any id substring to be matched to available archetypes,
				...
				<li value="0">Improved validation for VSONIR cases; comparison of ranges for existence, occurrences and cardinality comparison in
				...
				<li value="0">moved error database to files under $app_install/error_db;</li>
				<li value="0">Addition and refactoring of code base to create new applications:
				<ul>
				...
				<li value="0">Release notes now displayed in default browser at installation time;</li>
				<li value="0">Updates to help pages, including Mac installer and regression test facility.</li>
			</ul>


			<h3>11 Aug 2010 ADL 1.5 beta Release 1 (<a href=
			"http://www.openehr.org/svn/ref_impl_eiffel/!svn/bc/1105/BRANCHES/specialisation/">SVN rev 1105</a>):</h3>
			...
			<h3>22 Mar 2009 ADL 1.5 Preview Release 1.5.0 (<a href=
			"http://www.openehr.org/svn/ref_impl_eiffel/!svn/bc/851/BRANCHES/specialisation/">SVN rev 851</a>):</h3>
			...
			<h3>02 Apr 2008 Release 1.4.1 (<a href=
			  "http://www.openehr.org/svn/ref_impl_eiffel/TAGS/Release-1.4.1">SVN rev 599 / TAG Release-1.4.1</a>)</h3>
				<ul>
				...
				<h3>09 Apr 2007 Release 1.4.0 (<a href="http://www.openehr.org/svn/ref_impl_eiffel/!svn/bc/203/TRUNK/">SVN
				rev 203</a>):</h3>
				...
				<h3>02 Mar&nbsp;2007 Release (<a href="http://www.openehr.org/svn/ref_impl_eiffel/!svn/bc/166/TRUNK/">SVN
				rev 166</a>)</h3>:

				<ul>
				  <li value="0">Upgrade ADL workbench to <span style="FONT-WEIGHT: bold">process ADL 1.4 languages
				  section</span>, including translations - and display on &#39;description&#39; tab<br /></li>
				...
				<ul>
				  <li value="0">Repository merging - local and reference repositories can now be merged and viewed as one
				  logical repository</li>
			...
			<ul>
			  <li>enhancements:
				...
				<ul>
				  <li>now can have two archetypes in memory at once, due to getting rid of current_archteype from
				  SHARED_ARCHETYPE_CONTEXT object</li>
				</ul>
			  </li>
			  ...
			  <li>bug fixes:
				...
				<ul>
				  ...
				  <li>fixed minor bug in path testing where a path ending in attr[obj_id] would match the OG structure when
				  it should not</li>
			...
			<ul>
			  <li>enhancements
				...
				<ul>
				  <li>more efficient implementation of DT_OBJECT_CONVERTER, which now checks far fewer types when comparing
				  generic types</li>
				</ul>
			  </li>
			  ...
			  <li>bugfixes
				...
				<ul>
				  <li>better structure of code with respect to use of SHARED_ADL_INTERFACE, which slved .Net DLL crash
				  problem.</li>
				</ul>
			  </li>
			</ul>
			...
			<ul>
			  <li>changes:
				...
				<ul>
				  <li>library package structure significantly improved. Note that this will mean that .Net users will see
				  that many classes are in a new namespace. The main change is that the am package is now populated as
				  described in the Archetype Object Model (AOM) documentation.</li>
				</ul>
			  </li>
			</ul>
   ...
   create_expr_unary_operator_node (an_operator: INTEGER; h_an_operand: INTEGER): INTEGER
					  ...
					  <li>codes for an_operator argument given in openEHR AOM specification - the new classes OPERATOR_KIND
					  and OPERATOR_TYPES are added. To make a call to one of the above functions, an OPERATOR_KIND object
					  needs to be created using the c# syntax which has the effect of doing OPERATOR_KIND.make(integer
					  value) or OPERATOR_KIND.make_from_string(string value)</li>
					</ul>
				  </li>
				</ul>
			  </li>
			  <li>bugs:
				<ul>
				  <li>some bugs remain in the java wrapping; compiles ok, but runtime errors at assertion building. - More
				  functions need to be wrapped for ARCHETYPE_DESCRIPTION, adding invariants to ARCHETYPE etc.</li>
				</ul>
			  </li>
			</ul>
			...
			<ul>
			  <li>enhancements
				...
				<ul>
				  <li>implemented ARCHETYPE_DESCRIPTION class, parsing, and GUI view. Upgraded all test archetypes. - added
				  new class DT_OBJECT_CONVERTER, which performs generic DT_ &lt;-&gt; object structure conversion. This
				  enables the archetype description and any other dADL content to be converted automatically into objects,
				  rather than requiring hand-built routines.</li>
				</ul>
			  </li>
			</ul>
			...
			<ul>
			  <li>enhancements
				...
				<ul>
				  <li>News facility added: a news window will pop up the first time the workbench is used with a new
				  version.</li>
				</ul>
			  </li>
			</ul>
