...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<ul>
				<li>$profile, i.e. names of your repository profiles, e.g. &#39;CKM&#39;, &#39;ADL_1.5_test&#39;,
				etc</li>
			...
			<ul>
				<li><em>Parse</em>: perform a normal compile on the archetype; if there is only a legacy (.adl) file
				available, an initial .adl to .adls conversion will be done;</li>
				<li><em>Regression</em>: perform a regression comparison of the compilation results with expected
				...
				<li><em>Save legacy</em>: if there is a .adl (ADL 1.4) file, save it to the directory , to the
				directory $diff_test/$profile/flat/orig, with a &#39;.adlf&#39; extension;</li>
				<li><em>Save flat</em>: serialise the in-memory flat archetype out to the directory , to the
				directory $diff_test/$profile/source/new;</li>
				<li><em>Compare src</em>: perform a simple compare between the original source (.adls) file contents
			...
			<p>The regression testing facility is intended to be used with the test archetypes found in
			the <a href ="http://www.openehr.org/svn/knowledge2/">knowledge2 SVN repository</a>, in
			the TRUNK\archetypes\ADL_1.5_test directory. This directory contains 150+ archetypes
			designed specifically to exercise the ADL compiler. Each such archetype is hand-built
			to either pass or fail, exercising a specific part of the ADL 1.5 specification.</p>
			...
			<p>The main purpose of regression tests is to test the compiler software, and particularly changes in the software.
			After any change is made, the regression tests should be executed to find any failures. The validity code being tested is indicated in the results column.</p>
			<p>The regression testing facility has been designed to be independent of any particular tool technology,
			and the logic implemented in the Eiffel ADL Workbench can easily be replicated in Java, .Net and other tools.</p>
