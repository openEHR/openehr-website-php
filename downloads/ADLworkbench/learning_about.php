<?php
$PageName = 'ADL Workbench: About ADL 1.5';
?>
...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<ul>
				<li><a href="https://github.com/openEHR/specifications/blob/master/publishing/architecture/am/adl1.5.pdf">The Archetype Definition Language 1.5 (draft)</a></li>
				<li><a href="https://github.com/openEHR/specifications/blob/master/publishing/architecture/am/aom1.5.pdf">The Archetype Object Model 1.5 (draft)</a></li>
				<li><a href="https://github.com/openEHR/specifications/blob/master/publishing/architecture/am/dist_dev_model.pdf"><i>open</i>EHR Distributed Knowledge Development (draft)</a></li>
				<li><a href="https://github.com/openEHR/specifications/blob/master/publishing/architecture/am/knowledge_id_system.pdf"><i>open</i>EHR Distributed Artefact Identification System (draft)</a></li>
			</ul>
...
annotations
  ...
  &gt;
			...
			<p>Annotations can be viewed in the Annotations tab in either differential or flat form. The example archetypes <a href="https://github.com/openEHR/adl-archetypes/tree/master/ADL15-reference/validity/annotations/">here</a>, are displayed in a grid, as in <a href="images/annotations_tab.png">this screenshot.</a></p>
