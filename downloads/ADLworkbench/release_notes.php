<?php
$PageName = 'ADL Workbench: Release Notes';
?>
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<ul>
				...
				<li>Migrate to dADL format configuration .cfg file, providing greater readability and flexibility <a href="tool_configuration#cfgfile">(details)</a>;</li>
