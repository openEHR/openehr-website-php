	...
	<div id="BottomMenu">
		...
		<div class="BottomMenuSection" style="left:40px;">
			<p class="MenuHeading">Especificaciones</p>
			<ul>
				<li><a href="/programs/specification/releases/1.0.2" title="Current official release of specifications">Liberación Actual</a></li>
				<li><a href="/programs/specification/releases/currentbaseline" title="Specifications development baseline">Versión Actual</a></li>
				<li><a href="/issues/browse/SPECPR" target="_blank" title="Specifications issue tracker (Jira)">Gestor de Incidencias</a></li>
				<li><a href="/releases/1.0.2/reference-models/openEHR/XSD" target="_blank" title="Reference Model XML Schemas (current release)">Esquemas XML</a></li>
		...
		<div class="BottomMenuSection" style="left:245px;">
			...
			<ul>
				...
				<li><a href="/ckm/#repositoryoverview" title="Clinical Knowledge Manager mindmap of all archetypes">CKM Mapas Mentales de Arquetipos</a></li>
				<li><a href="/ckm/#userstatistics" title="Clinical Knowledge Manager user statistics">CKM Estadísticas de Usuarios</a></li>
				<li><a href="/wiki/display/spec/openEHR+Terminology" title="openEHR terminology/vocabulary page">Terminología de openEHR</a></li>
		...
		<div class="BottomMenuSection" style="left:455px;">
			...
			<ul>
				<li><a href="/resources/learning_centre">Centro de Aprendizaje</a></li>
				<li><a href="/resources/publications">Publicaciones</a></li>	
				...
				<li><a href="/resources/related_projects">Proyectos Relacionados</a></li>
			</ul>
		</div>

		<div class="BottomMenuSection" style="left:645px;">
			<p class="MenuHeading">Comunidad</p>
			<ul>
				<li><a href="/wiki" target="_blank">Wiki</a></li>
				<li><a href="https://github.com/openEHR" target="_blank">GitHub</a></li>
				<li><a href="/community/mailinglists">Listas de Correo</a></li>
		...
		<div class="BottomMenuSection" style="left:815px;">
			<p class="MenuHeading">¿Cómo utilizar el sitio?</p>
			<ul>
				<li><a href="/using_the_site/terms_of_use">Términos de Uso</a></li>
				<li><a href="/using_the_site/privacy_policy">Política de Privacidad</a></li>
				<li><a href="/using_the_site/syndication">Syndication</a></li>
				<li><a href="/using_the_site/feedback">Retroalimentación</a></li>
				<li><a href="/using_the_site/site_map">Mapa del Sitio</a></li>
			</ul>
		</div>
	</div>

	<div id="BottomPanel">
		<p><span style="color:#023760;">Copyright &copy; <?php echo date("Y");?> Fundación openEHR. Todos los derechos reservados | <a href="mailto:webmaster@openehr.org">Webmaster</a></span></p>
	</div>
