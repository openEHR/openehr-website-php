...
<div id="MainFrame">
	...
	<div id="MainArea" style=" margin-left:30px; width:900px; height:1000px;">
		...
		<h2>Benefits</h2>
		<p>There are some basic benefits to openEHR's approach. Firstly, it is now possible to build an EHR repository independently of content specifications. In other words, your EHR system doesn't need to know a priori about any of the clinical data it will process, such as vital signs, diagnoses or orders. Models for those things are developed separately. Models for data sets and forms are also developed separately, and UI form components are now generatable from these definitions. This enables <b>a new generation of EHR systems that routinely adapts to new requirements</b> - because that's how the architecture is designed in the first place.</p>
		<p>Another great benefit is <b>portable queries</b> - queries based on content models, not phsyical database schemas. Coupled with EHR and vEHR service interface APIs, these are enabling a new class of decision support tools.</p>
		<p>In clinical terms, health professionals are now for the first time experiencing direct involvement in the construction and ongoing development of EHR systems. This means that <b>the quality of the data is better</b> - they designed it, and it also enables applications that work for them to be built.</p>
		<p>Strategically, the openEHR approach enables a <b>platform-based e-health software market</b>, in which vendors and developers of back-end and front-end solutions interface via standardised information, standardised content models and terminology, and standardised service interfaces. This gives procurement stakeholders new choices.</p>
		<h2>Methods</h2>
