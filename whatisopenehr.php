...
<div id="MainFrame">
	...
	<div id="MainArea" style=" margin-left:30px; width:900px; height:1000px;">
		...
		<br/>
		<p>openEHR is a virtual community working on interoperability and computability in e-health. Its main focus is electronic patient records (EHRs) and systems. Its technical approach is 'multi-level modelling' within a service-oriented software architecture, in which models built by domain experts are in their own layer.</p>
		...
		<p>Another great benefit is <em>portable queries</em> - queries based on content models, not phsyical database schemas. Coupled with EHR and vEHR service interface APIs, these are enabling a new class of decision support tools.</p>
