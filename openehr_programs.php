...
?>
	...
	<div id="MainArea" style="margin-left:60px; margin-top:35px; margin-bottom:100px; width:900px;">
		...
		<div id="Content">
			...
			<img src="/files/programs/SpecificationFrame.png" usemap="#specification" align="left"/>
			...
			<img src="/files/programs/ModelsFrame.png" usemap="#models" align="left"/>
			<map name="models">
			...
			<img src="/files/programs/SoftwareFrame.png" usemap="#software" align="left"/>
			<map name="software">
			...
			<img src="/files/programs/LocalisationFrame.png" usemap="#localisation" align="left"/>
