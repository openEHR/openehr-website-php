<span>Resources</span>
			<ul>
				<li><a href="/resources/zotero" title="Publications@Zotero" target="_blank">Publications@Zotero</a></li>
				...
				<li><a href="/resources/publications" <?php if($pageOn == 'publications.php'){?> class="active"<?php }?>>Publications (old)</a></li>
			</ul>
