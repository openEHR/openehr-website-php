...
?>
	...
	<div id="MainArea">
		...
		<div id="Content">
			...
			<p>All these problems are addressed and reflected in the approach proposed by openEHR community. The endeavour of this community is coordinated and promoted by <a href="/pt/about/foundation">openEHR Foundation</a>.</p>
			
			<h2>What is the openEHR approach?</h2>
			<p>The openEHR approach is <em>multi-level, single source modelling</em> within a service-oriented software architecture, in which models built by domain experts are in their own layer. It is delineated by a <a href="/pt/programs/specification/releases/currentbaseline">set of specifications</a> published by the openEHR Foundation.</p>
			...
			<p>This website will give you information on how it all works, and how to become a <a href="/pt/about/membership">member of openEHR</a>. The openEHR approach offers opportunities and value to many different stakeholders, including clinicians, health care providers, governments, software developers and research institutions.</p>
			...
			<p>Are you a <a href = "/pt/getting_involved/providers_clinicians">clinician or health care provider</a>? You can help creating and reviewing the <a href="http://www.openehr.org/ckm/" target="_blank">archetypes</a>. Are you a message designer? You may want to get involved in building template-based message specifications, based on the archetypes. Are you a <a href = "/pt/getting_involved/vendors_developers">software vendor or developer</a>? You can help build the new generation of EHR tools. If you are a <a href = "/pt/getting_involved/universities_researchcentres">researcher</a>, you can get involved in specifying how openEHR querying, published terminologies and standards like CDISC can be used to improve how longitudinal data-based studies are done. Maybe you want to obtain tools and solutions? You will find <a href = "/pt/industry_partners/">vendor solutions</a>, as well as <a href="/pt/programs/software">open source components</a>. If you are from the <a href = "/pt/getting_involved/governmentbodies_programmes">government institution</a>, the openEHR approach can provide a platform to integrate your local eHealth systems.</p>
