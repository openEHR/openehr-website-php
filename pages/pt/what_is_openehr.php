...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<p>The openEHR approach is <em>multi-level, single source modelling</em> within a service-oriented software architecture, in which models built by domain experts are in their own layer. It is delineated by a <a href="/pt/programs/specification/workingbaseline">set of specifications</a> published by the openEHR Foundation.</p>
