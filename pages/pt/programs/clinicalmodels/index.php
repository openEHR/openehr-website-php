...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<h2>Terminologias</h2>
			<p>Terminologias são tão antigas quanto os computadores em saúde. Inicialmente usadas para minimizar espaço em disco, o uso de terminologias cresceu a ponto de classificar o cuidado em saúde ofertado e, mais recentemente, por meio do SNOMED-CT (<a href="http://www.ihtsdo.org/" target="_blank">IHTSDO</a>) para apoiar processos clínicos automatizados. Arquétipos, e o openEHR nesta questão, são planejados para trabalhar com terminologia.</p>
			
			<h4>Arquétipos e Terminologias</h4>
			<p>Cada termo em um arquétipo pode ser unificado a uma terminologia para melhor compreensão da intenção do autor. Além disso, os arquétipos permitem a expressão de subconjuntos para determinar os conjuntos de termos de valores mais adequados em um  ponto de dados específico. Isto é conhecido como 'definição de restrição' e é um espaço reservado para um conjunto de valores que é oferecido ao usuário dentro da aplicação.</p>
			
			<h4>Modelos (Templates) and Terminologias</h4>
			<p>Terminologias usadas no Cuidado à Saúde incluem <a href="http://www.who.int/classifications/icd/en/" target="_blank">ICD-10</a> (e seus predecessores ICD-9), <a href="http://www.ihtsdo.org/snomed-ct/" target="_blank">SNOMED-CT</a>, <a href="http://loinc.org/" target="_blank">LOINC</a> e muitas outras</p>
			<p>A maioria das terminologias utiliza códigos como identificadores ou referências para cada termo ou conceito individual. Códigos e identificadores são utilizados geralmente para auxiliar o processamento por computador em lugar de pessoas.</p>
			
			<h4>Códigos, Registros Eletrônicos em Saúde (EHRs) e Interoperabilidade Semântica</h4>
			<p>Ouve-se com frequência que dados codificados são essenciais para a interoperabilidade semântica e suporte à decisão. Codificação é o uso de símbolos, ou identificadores alfanuméricos para assinalar itens de dado como referência a conceitos ou termos oriundos de um vocabulário ou ontologia de consenso. Codificação, pode, em várias circunstâncias ter o mesmo valor. Mas isto acontece por um preço. Este <a href="http://www.openehr.org/wiki/display/healthmod/Codes%2C+EHRs+and+Semantic+Interoperability" target="_blank">artigo</a> faz um balanço e provoca as questões a serem enfrentadas por aqueles que fazem recomendações para Registros Eletrônicos em Saúde e a Interoperabilidade Semântica.</p>
			
			
			<h2>Governança do Conhecimento Clínico (Clinical Knowledge Governance)</h2>
			<p><a href="documentation">O Gestor do Conhecimento Clínico (Clinical Knowledge Manager- CKM)</a> (disponível em <a href="http://www.openehr.org/ckm/" target="_blank">aqui</a>) openEHR é uma aplicação on-line que suporta a governança do conhecimento dentro e através das organizações de Saúde. Na prática, é um sistema para desenvolvimento colaborativo, gerenciamento e public ação de um extenso conjunto de recursos de conhecimentos clínicos incluindo arquétipos, modelos (templates) e subconjuntos de terminologia.</p>
			
			
			<h2>Processo clínico incluindo orientações, fluxo de trabalho e linhas de atenção</h2>
			<p>O objetivo de todo este trabalho é apoiar o processamento automatizado de informações em saúde para assistir pessoas e seus provedores de cuidados de saúde em obter os melhores resultados de saúde possíveis. Um grande esforço de trabalho e pesquisa foi despendido no estabelecimento de maneiras de prover essa assistência. Com o openEHR, é possível pela primeira vez expressar declarações de processos dependentes de informações em saúde (como tomar prednisolona 50mg por dia, se a medida de pico de fluxo cai abaixo de 200 L / min em duas manhãs consecutivas) usando termos formais. Isto é em virtude do openEHR possuir uma linguagem de recuperação de registros que permite a construção de sentenças com base em arquétipos que especificam a informação.</p>
