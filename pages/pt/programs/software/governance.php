...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<p>A maior parte das decisões de trabalho e software devem ser discutidos <a href="/pt/community/mailinglists.php">na lista de discussão openehr-implementers </a>onde qualquer um pode contribuir para o assunto em pauta (não é necessário ser um associado).</p>
