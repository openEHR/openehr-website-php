<span style="line-height:150%;"><a href="/pt/programs/specification" <?php if($pageOn == 'index.php'){?> class="active"<?php }?> style="font-weight:900;">Programa de <br/>Especificações</a></span>
			<ul>
				...
				<li><a href="/issues/browse/SPECPR" target="_blank">&nbsp; Rastreador de Problemas</a></li>
