...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<tr>
				...
				<td> <a href="/releases/1.0.2/architecture/overview.pdf" target="_blank">Architecture Overview</a></td>
			...
			<tr>
				...
				<td> <a href="/releases/1.0.2/architecture/rm/ehr_im.pdf" target="_blank">EHR IM</a></td>
				<td> The information model of the openEHR EHR. </td>
				<td> stable</td>
			</tr>
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/demographic_im.pdf" target="_blank">Demographic IM</a></td>
				<td> The openEHR demographic model. </td>
				<td> stable</td>
			</tr>
			<tr style="background-color:#FFFCDC;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/ehr_extract_im.pdf" target="_blank">EHR Extract IM</a></td>
				<td> The information model of the EHR Extract, which is a serilialisation of content from an EHR. </td>
				<td> development</td>
			</tr>
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/common_im.pdf" target="_blank">Common IM</a></td>
			...
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/data_structures_im.pdf" target="_blank">Data Structures IM</a></td>
				<td> Information model of data structures, incuding a powerful model of HISTORY and EVENT. </td>
				<td> stable</td>
			</tr>
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/data_types_im.pdf" target="_blank">Data Types IM</a></td>
			...
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/support_im.pdf" target="_blank">Support IM</a></td>
			...
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/rm/integration_im.pdf" target="_blank">Integration IM</a></td>
			...
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/am/adl.pdf" target="_blank">Archetype Definition Language 1.4 (ADL)</a></td>
				<td> Abstract syntax specification for archetypes 1.4 edition of language (used in ISO 13606-2). </td>
				<td> stable</td>
			</tr>
			<tr>
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="/releases/1.0.2/architecture/am/aom.pdf" target="_blank">Archetype Object Model (AOM)</a></td>
