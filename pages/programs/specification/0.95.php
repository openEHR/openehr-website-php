...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td> <a href="http://www.openehr.org/releases/0.95/requirements/iso18308_conformance.pdf" target="_blank">ISO 18308 Conformance Statement</a></td>
				<td> &nbsp;</td>
			...
			<tr>
				...
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/ehr_im.pdf" target="_blank">EHR IM</a> </td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFEECC;">
				...
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/demographic_im.pdf" target="_blank">Demographic IM</a> </td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFFFDD;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/ehr_extract_im.pdf" target="_blank">EHR Extract IM</a> </td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFEECC;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/common_im.pdf" target="_blank">Common IM</a> </td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFEECC;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/data_structures_im.pdf" target="_blank">Data Structures IM</a> </td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFEECC;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/data_types_im.pdf" target="_blank">Data Types IM</a></td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFEECC;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/rm/support_im.pdf" target="_blank">Support IM</a> </td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFFFDD;">
				...
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/am/archetype_system.pdf" target="_blank">Archetype System</a></td>
				<td> &nbsp;</td>
			...
			<tr style="background-color:#FFFFDD;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/am/adl.pdf" target="_blank">Archetype Definition Language 1.2 (ADL)</a></td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFFFDD;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/am/aom.pdf" target="_blank">Archetype Object Model (AOM)</a></td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFFFDD;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/am/openehr_archetype_profile.pdf" target="_blank">openEHR Archetype Profile (OAP)</a></td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#FFFFDD;">
				<td style="background-color:#FFFFFF;"> &nbsp;</td>
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/am/archetype_principles.pdf" target="_blank">Archetypes Principles</a></td>
				<td> &nbsp; </td>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td> <a href="http://www.openehr.org/releases/0.95/CM/CM_plan.pdf">CM Plan</a> </td>
				<td> &nbsp;</td>
			...
			<tr style="background-color:#F3F8FA;">
				...
				<td> <a href="http://www.openehr.org/releases/0.95/architecture/modelling_guide.pdf">Modelling Guide</a> </td>
				<td> &nbsp;</td>
				<td> Technical document describing how versioning, changes, and releases are made. Describes the workflow of the Architectural Review Board (ARB).</td>
				<td> stable</td>
			</tr>
