...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<ul>
				<li>anyone can <a href="http://www.openehr.org/issues/browse/SPEC?report=com.atlassian.jira.plugin.system.project:openissues-panel" target="_blank">raise a PR</a> to indicate some issue or problem with the current release. A PR documents the issue seen from the user's perspective, with the resolution being provided by the development team.</li>
				<li>only a member of the development team can raise a CR. All open CRs can be <a href="http://www.openehr.org/issues/browse/SPEC?report=com.atlassian.jira.plugin.system.project:roadmap-panel" target="_blank">viewed here</a> (completed CRs are <a href="http://www.openehr.org/issues/browse/SPEC?report=com.atlassian.jira.plugin.system.project:changelog-panel" target="_blank">here</a>). A CR documents a change to the current release. A CR will either describe the problem it is solving, or refer to one or more PRs it is designed to address. The CR is a document of the change and the process of applying it to the release.</li>
			</ul>
