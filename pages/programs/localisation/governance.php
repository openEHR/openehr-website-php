...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<p class="content1"><a href="#qualifiedmembers">Qualified Members</a></p>
				<p class="content2"><a href="#qmresponsibilities">Responsibilities</a></p>
				<p class="content2"><a href="#qmoutputs">Outputs</a></p>
				<p class="content2"><a href="#qmmembership">Membership</a></p>
			<p class="content1"><a href="#localprogramcommittee">Localisation Program Committee</a></p>	
				<p class="content2"><a href="#lpcresponsibilities">Responsibilities</a></p>
				<p class="content2"><a href="#lpcmembership">Membership</a></p>
				<p class="content2"><a href="#lpccommitment">Commitment</a></p>
				<p class="content2"><a href="#lpcconflicts">Conflicts of Interest</a></p>
				<p class="content2"><a href="#lpcdecisionmaking">Decision-making</a></p>
			<p class="content1"><a href="#communications">Communications</a></p>
				<p class="content2"><a href="#withfoundation">With the Foundation</a></p>
				<p class="content2"><a href="#withprograms">With other Programs</a></p>
				<p class="content2"><a href="#withcommunity">With the wider openEHR Community</a></p>
			<p class="content1"><a href="#meetings">Meetings</a></p>
			<p class="content1"><a href="#ipissues">IP Issues</a></p>
			...
			<a href = "/files/programs/localisation/LocProgStr.png"><img src="/files/programs/localisation/LocProgStr.png" alt="Specification Program Structure" class = "imgMiddle width50"/></a>
			...
			<ul>
				...
				<li>monitor the agenda and work items,
				<ul>
					<li>discuss within the group on issues arising</li>
					<li>tweak if necessary</li>
					<li>advise LPC is there's a need for resolution of issues</li>
				</ul>
				</li>
				<li>meet regularly (period TBD) to discuss issues arising and report on progress</li>
				<li>keep website, training material and other localisation assets up-to-date and correct</li>
				<li>develop ideas around promotion, projects, collaborations, partnerships etc.</li>
				<li>disseminate outputs
				<ul>
					<li>attend local conferences, showcases etc.</li>
					<li>publish scholarly articles, newsletters, whitepapers etc.</li>
				</ul>
				</li>
				<li>make education a high priority
				<ul>
					<li>organise tutorials, workshops, special courses etc.</li>
					<li>contribute to educational programs, curricula</li>
				</ul>
				</li>
				<li>foster research
				<ul>
					<li>contribute to local research environment</li>
					<li>seek funding for projects, students, travel etc.</li>
				</ul>
				</li>
			</ul>
			...
			<p>These comprise:</p>
			<ul>
				<li>translation of specifications, clinical models and other existing resources (e.g. documents, presentations, marketing and training material, schemas, etc.)</li>
				<li>localisation of existing software (e.g. translation and adaptation of tools, components etc.)</li>
			...
			<ul>
				<li><em>An understanding of the overall openEHR mission</em>.</li>
			...
			<ul>
				...
				<li>community: active participation to the lists and the wiki? other activities?</li>
			</ul>
			...
			<ul>
				<li>there is no limit on duration of QM, as long  as the participation and competence are maintained..</li>
				<li>a QM can leave or may be removed by the LPC due to inappropriate conduct.</li>
			</ul>


			<h2><a name="localprogramcommittee"></a>Localisation Program Committee (LPC)</h2>
			...
			<ul>
				...
				<ul>
					<li>help with their local establishments (e.g. assist preparing their local TOR)</li>
					<li>resolving local/global IP issues</li>
					<li>publishing local content</li>
					<li>mediating local training strategies, material development and maintenance</li>
					<li>help with promotion strategies in local environments</li>
				</ul>
				</li>
				<li>communication to the wider openEHR community of issues of general interest</li>
				<li>communication to other Programs (Specification, Software, Clinical Models)</li>
				<li>communication to the Foundation of any local issues arising which needs Board's attention
				<ul>
					<li>getting promotion support and material (e.g. endorsements, MoUs etc.)</li>
					<li>aligning local strategies and works with that of the Foundation</li>
				</ul>
				</li>
			...
			<h3><a name="lpcconflicts"></a>Conflicts of Interest</h3>
			...
			<ul>
				...
				<li>The results of the community review will be the basis of a further  round of discussions within the LPC aimed at finding a consensus  decision;</li>
				<li>If this still fails, a formal 2/3 majority  vote will be taken, unless objections to this route are voiced from within the LPC.</li>
			</ul>
			...
			<ul>
				...
				<li>The current membership of the Program, including QM, LPC, and Local Members is posted and maintained on a wiki page.</li>
			</ul>
