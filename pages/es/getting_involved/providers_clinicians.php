...
$PageName = 'Instituciones de Salud';
...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<p>You can join the <a href="/es/community/mailinglists">mailing lists</a> as a first step. There are more than 1000 people from 75+ countries already there. You can also become part of openEHR as an Individual member. Find out more about <a href="/es/about/membership#individualmembership">membership</a>.</p>
			
			
			<h2>How openEHR works for others</h2>
			<p>You can find information about openEHR users <a href="http://openehr.org/ckm/#userstatistics" target="_blank">here</a>.</p>
