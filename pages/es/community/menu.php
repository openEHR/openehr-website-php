<span>Comunidad</span>
					<ul>
						<li><a href="http://www.openehr.org/wiki" target="_blank">Wiki</a></li>
						<li><a href="https://github.com/openEHR" target="_blank">GitHub</a></li>
						<li><a href="/es/community/mailinglists"  <?php if($pageOn == 'mailinglists.php'){?> class="active"<?php }?>>Listas de Correo</a></li>
