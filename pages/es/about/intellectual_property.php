...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<tr>
				...
				<td>Copyright openEHR Foundation, licensed under Creative Commons CC-BY-ND. <a href="/es/programs/specification/iplicense">Details</a></td>
			</tr>
			<tr>
				<td><em>Clinical Models</em></td>
				<td>Archetypes, Templates and Terminology subsets developed by the community</td>
				<td>Creative Commons for organisational and individual use. CC-BY-(SA) The Share Alike (SA) is specifically applied to derived archatypes and templates only. <a href="/es/programs/clinicalmodels/iplicense">Details</a></td>
			</tr>
			<tr>
				<td><em>Software</em></td>
				<td>Software with IP rights ascribed to the openEHR Foundation</td>
				<td>Apache 2 License. <a href="/es/programs/software/iplicense">Details</a></td>
			</tr>
			</tbody>
			</table>
