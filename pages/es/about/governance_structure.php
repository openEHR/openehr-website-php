...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<p>See members of openEHR Management Board <a href="/es/about/management_board">here</a>.</p>
			...
			<ul>
				<li><a href="/es/programs/specification/governance">Specification Program</li>
				<li><a href="/es/programs/clinicalmodels/governance">Clinical Program</li>
				<li><a href="/es/programs/software/governance">Software Program</li>
				<li><a href="/es/programs/localisation/governance">Localisation Program</a></li>
			</ul>
