...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<h2>Legal Status</h2>
			<p>The openEHR Foundation is a not-for-profit company, limited by guarantee, of University College London, UK. It is regulated under the UK Companies Acts 1985 and 1989. The name 'openEHR' has been registered internationally as a Trade Mark. One of its main legal functions is as the holder of its Intellectual Property, which it <a href="/es/about/intellectual_property">makes freely available</a>.</p>
			...
			<ul>
				<li><a href="/es/programs/specification/">Specification Program</a>:
					<ul>
				...
				<li><a href="/es/programs/clinicalmodels/">Clinical Models Program</a>: 
					<ul>
