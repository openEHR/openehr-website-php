...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<p>This document describes the Change Management of the openEHR Specification Program, and is part of the <a href="/es/programs/specification/governance">governance Terms of Reference</a> for the program. Specifications are divided into major Components (identified in the 'Component' column of the <a href="/es/programs/specification/workingbaseline">current baseline</a>). They are managed by the <a href="/es/programs/specification/governance#sec">Specifications Editorial Committee (SEC)</a>, according to the process described here. All change and release management is <a href="https://openehr.atlassian.net/browse/SPEC" target="_blank">visible online</a>.</p>
