...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<p>The majority of the work and software decisions should be discussed on the <a href="/es/community/mailinglists.php">openehr-implementers mailing list</a> where anybody can contribute to the concensus-targeted discussion (no qualified membership required).</p>
