<span>Recursos</span>
			<ul>
				...
				<li><a href="/es/resources/white_papers" <?php if($pageOn == 'white_papers.php'){?> class="active"<?php }?>>Libros Blancos</a></li>
				<li><a href="/es/resources/related_projects" <?php if($pageOn == 'related_projects.php'){?> class="active"<?php }?>>Proyectos Relacionados</a></li>
			</ul>
