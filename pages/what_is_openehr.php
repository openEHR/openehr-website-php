...
?>
	...
	<div id="MainArea" style=" margin-left:60px; margin-top:35px; margin-bottom:100px; width:900px;">
		...
		<div id="Content">
			...
			<h2>A Health Computing Platform for a Connected World</h2>
			...
			<ul>
				<li><em>avoid product and vendor lock-in</em>;</li>
				<li><em>retain ownership of the data</em> for secondary use;</li>
				<li><em>let their clinical experts be directly involved</em> in solution development, via archetype authoring.</li>
			</ul>
			...
			<p><a href="/files/what_is_openehr/openehr_platform_stakeholders.png"> <img src="/files/what_is_openehr/openehr_platform_stakeholders.png" alt="openEHR platform stakeholders image" title="Click to enlarge" width="240" style="margin-left:30px; margin-bottom:10px; border: solid 1px #CCCCCC; float:right;"/></a>
