...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<p>Various prerequisite software is needed for the Mac version of ADL Workbench. There are two ways of obtaining this - MacPorts and HomeBrew. Once you have completed one of these steps, download and install the appropriate version of ADL Workbench for your Mac.</p>
            ...
            <ul>
				...
				<li>Install the latest version of <a href="http://developer.apple.com/technologies/xcode.html" target="_blank">Xcode Tools</a> for your Mac.</li>
				<li>Install the latest version of <a href="http://www.macports.org/install.php" rel="nofollow" target="_blank">MacPorts</a>.</li>
            ...
            <ul>
				<p>Make sure XQuartz is installed.  To install it follow the instructions <a href="http://xquartz.macosforge.org/landing/" target="_blank">here</a>.</p>
				<p>Make sure you don't have macports installed.  To uninstall macports follow the instructions <a href="http://guide.macports.org/chunked/installing.macports.uninstalling.html" target="_blank">here</a>.</p>
				<p>Install homebrew by following the instructions <a href="http://mxcl.github.io/homebrew/" target="_blank">here (at the bottom of the page)</a>.</p>
