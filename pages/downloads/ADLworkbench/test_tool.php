...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<ul>
				...
				<li><em>Regression</em>: perform a regression comparison of the compilation results with expected results, which are encoded in the archetype details/other_deals section using the &quot;regression&quot; tag. See <a href="https://github.com/openEHR/adl-archetypes/blob/master/ADL15-reference/validity/basics/openEHR-TEST_PKG-ENTRY.VACCD_illegal_concept_code.v1.adls"> this archetype</a> for example. Regression testing is only performed if the Regression button on the user interface is selected by the user, as it involves some extra computing cost, and is only useful for test archetypes found in the test repository, or archetypes similarly including the &quot;regression&quot; item within the details/other_deals.</li>
