...
<!-- ------------------------------------------- Content starts here ------------------------------------------------- -->
			...
			<p><a href="release_notes">Release notes</a> - <a href="http://www.openehr.org/issues/browse/AWBPR" target="_blank">Report an issue (Jira)</a> - <a href="http://www.openehr.org/issues/browse/AWB" target="_blank">Development Project (Jira)</a>; <a href="#interim_builds">Next release interim builds</a></p>
			...
			<h3 id="interim_builds">Next release interim builds</h3>
            <table class="TableBasic">
				<tbody>
					<tr>
						<th> Platform </th>
