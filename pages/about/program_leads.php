...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<h2 style="margin-left:1em;">Thomas Beale - Specification Program (United Kingdom)</h2>
			...
			<tr>
				...
				<p> 
					<a href="http://wolandscat.net" target="_blank"><img height="24" width="24" src="/gui/social/wordpress-icon.png"/></a>
					<a href="http://uk.linkedin.com/in/thomasbeale" target="_blank"><img height="24" width="24" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/wolands_cat" target="_blank"><img height="24" width="24" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
			...
			<h2 style="margin-left:1em;">Heather Leslie MD, FRACGP, FACHI - Clinical Models Program (Australia)</h2>
			<table class="TableInvisible">
			<tbody>
			<tr>
				...
				<p>Lead since Jan 2012.</p>
				<p> 
					<a href="http://omowizard.wordpress.com/" target="_blank"><img height="24" width="24" src="/gui/social/wordpress-icon.png"/></a>
					<a href="http://au.linkedin.com/in/heatherleslie/en" target="_blank"><img height="24" width="24" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/omowizard" target="_blank"><img height="24" width="24" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
			...
			<h2 style="margin-left:1em;">Erik Sundvall PhD - Software Program (Sweden)</h2>
			<table class="TableInvisible">
			<tbody>
			<tr>
				...
				<p>Lead since Jan 2012.</p>
				<p> 
					<a href="http://se.linkedin.com/in/eriksundvall/en" target="_blank"><img height="24" width="24" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/ErikSundvall" target="_blank"><img height="24" width="24" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
			...
			<h2 style="margin-left:1em;">Dr. Koray Atalag - Localisation Program (New Zealand)</h2>
			<table class="TableInvisible">
			<tbody>
			<tr>
