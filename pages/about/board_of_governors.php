...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<h2 style="margin-left:1em;">Sam Heard MD, MRCGP, FRACGP, FACHI (Australia)</h2>
			<table class="TableInvisible">
			<tbody>
			<tr>
				<td style="text-align:center;"><img src="/files/about/SHeard.png"></td>
				<td width="650px">
				<p>Dr. Sam Heard is a practicing clinician who has worked throughout his career in inner London (UK) and the Northern Territory (Australia) to assist the standardisation of health information to empower clinicians and their patients to improve health care and outcomes.</p>
			...
			<h2 style="margin-left:1em;">Professor Dipak Kalra PhD, FRCGP (United Kingdom)</h2>
			<table class="TableInvisible">
			<tbody>
			<tr>
				<td style="text-align:center;"><img src="/files/about/DKalra.png"></td>
				<td width="650px">
				<p>Dipak Kalra, was Clinical Professor of Health Informatics at University College London, United Kingdom. He is President of the European Institute for Health Records (EuroRec) and a Director of the openEHR Foundation.</p>
