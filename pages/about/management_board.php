...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<tr>
				...
				<td width="650px">
				<p>Sam Heard is a practicing clinician who has worked throughout his career in inner London (UK) and the Northern Territory (Australia) to assist the standardisation of health information to empower clinicians and their patients to improve health care and outcomes.</p>
			...
			<tr>
				...
				<p> 
					<a href="http://se.linkedin.com/in/ronch" target="_blank"><img height="20" width="20" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/chenron" target="_blank"><img height="20" width="20" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
			...
			<tr>
				...
				<p>Elected Feb 2015.</p>
				<p> 
					<a href="http://si.linkedin.com/pub/tomaz-gornik/2/70b/473/en" target="_blank"><img height="20" width="20" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/marandlab" target="_blank"><img height="20" width="20" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
			...
			<tr>
				...
				<p>Elected Feb 2015.</p>
				<p> 
					<a href="http://openehrnz.wordpress.com/author/atalagk/" target="_blank"><img height="20" width="20" src="/gui/social/wordpress-icon.png"/></a>
					<a href="http://www.linkedin.com/pub/koray-atalag/0/5aa/b32" target="_blank"><img height="20" width="20" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/atalagk" target="_blank"><img height="20" width="20" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
			...
			<h3 style="margin-left:1em;">Ian McNicoll MD, MSc (Health Inf.) (United Kingdom)</h3>
			<table class="TableInvisible">
			<tbody>
			<tr>
				...
				<p>Elected Feb 2015.</p>
				<p> 
					<a href="http://uk.linkedin.com/in/ianmcnicoll/" target="_blank"><img height="20" width="20" src="/gui/social/linkedin-follow.png"/></a>
					<a href="http://twitter.com/ianmcnicoll" target="_blank"><img height="20" width="20" src="/gui/social/twitter-follow.png"/></a>
				</p>
				</td>
			</tr>
			</tbody>
