...
<!-- - - - - - - - - - - - - - - - - - - - - - - Content starts here - - - - - - - - - - - - - - - - - - - - - - - - - -->
			...
			<tr>
				...
				<td width="650px">
				<p>Rong Chen, MD PhD, is the Chief Medical Informatics Officer and the head of Medical Informatics Group at Cambio Healthcare Systems, Sweden. <p>Heâ€™s responsible for the research and development in clinical decision support and knowledge management at Cambio.</p>
				Rong holds a PhD degree in health informatics on the subject of EHR semantic interoperability from LinkÃ¶ping University, Sweden. He is an associated researcher at the Health Informatics Centre at Karolinska Institutet, where he lectures and supervises PhD and master students.</p>
