...
<div id="MainFrame">
	...
	<div id="MainArea" style=" margin-left:30px; width:900px; height:900px;">
		...
		<div id="TextArea" style="left:0px; width:900px; height:900px;">
			...
			<p>
			<a href="files/diagrams/single_source_models_stack.png"> <img src="files/diagrams/single_source_models_stack.png" width="300" align="right"/></a>
			openEHR is a virtual community working on interoperability and computability in e-health. Its main focus is electronic patient records (EHRs) and systems. Its technical approach is <b>multi-level modelling</b> within a service-oriented software architecture, in which models built by domain experts are in their own layer.</p>
