...
?>
	...
	<div id="MainArea" style=" margin-left:60px; margin-top:35px; margin-bottom:100px; width:900px;">
		...
		<div id="Content">
			...
			<p><a href="files/what_is_openehr/abstract_architecture.png"> <img src="files/what_is_openehr/abstract_architecture.png" title="Click to enlarge" width="240" align="right" style="margin-left:30px; margin-bottom:20px; border: solid 1px #CCCCCC;"/></a>
			...
			<p><a href="files/what_is_openehr/multi_level_modelling.png"> <img src="files/what_is_openehr/multi_level_modelling.png" title="Click to enlarge" width="240" align="left"  style="margin-right:30px; margin-bottom:20px; border: solid 1px #CCCCCC;"/></a>
			...
			<p><a href="files/what_is_openehr/openehr_platform+title+people.png"> <img src="files/what_is_openehr/openehr_platform+title+people.png" title="Click to enlarge" width="240" align="left"  style="margin-right:30px; margin-bottom:20px; border: solid 1px #CCCCCC;"/></a>
